...
$(function() {
	...
	$('.myTree').mousedown(function(){
		$(".treeDefault").find('p').css({'background-color':'#FDFDFD'});
		$(this).css({'background-color':'#ddd'});
	});
	
	$(".icon-arrow-right5").click(
		function(){
			var cla = $(this).attr('class');
			if(cla == 'icon-arrow-right5'){
				$(this).removeClass("icon-arrow-right5");
				$(this).addClass("icon-arrow-down5");
				$(this).parent().parent().parent().find("ul:first").slideDown();
			}else{
				$(this).removeClass("icon-arrow-down5");
				$(this).addClass("icon-arrow-right5");
